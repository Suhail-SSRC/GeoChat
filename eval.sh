...
#python geochat/eval/batch_geochat_vqa.py --model-path MBZUAI/geochat-7B --question-file datasets/GeoChat-Bench/lbern_small.jsonl --answers-file 
#datasets/LBERN/ans_4bit.json --image-folder datasets/LBERN/Images_LR/ --load-4bit >
