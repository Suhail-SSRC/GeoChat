...
def run_calibrate(args, tokenizer, model, image_processor):
    ...
    for i in tqdm(range(0,len(calib_questions),args.batch_size)):
            ...
            for j in range(i,batch_end):
                image_file=calib_questions[j]['image_id']+'.png'            
                qs="[identify] What is the object present at " + calib_questions[j]['question']
...
def eval_model(args):
    ...
    print(f"printing first question: {questions[0]}")
